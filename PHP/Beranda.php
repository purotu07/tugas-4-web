...
<body>
    ...
    <table class="table table-bordered">
        ...
        <?php
            include 'Koneksi.php';
                    ...
                    $query = "SELECT db_mahasiswa.*, wali_mahasiswa.nama_pengasuh
                            FROM db_mahasiswa
                            LEFT JOIN wali_mahasiswa ON db_mahasiswa.id_wali = wali_mahasiswa.id_wali";
    ...
    <button class="btn btn-primary">
        <a href="form-input.php" class="text-white text-decoration-none">Tambah Data</a>
    </button>
    <footer>
